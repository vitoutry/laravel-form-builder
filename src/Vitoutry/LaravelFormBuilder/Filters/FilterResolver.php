...
namespace Vitoutry\LaravelFormBuilder\Filters;

use Vitoutry\LaravelFormBuilder\Filters\Exception\InvalidInstanceException;
use Vitoutry\LaravelFormBuilder\Filters\Exception\UnableToResolveFilterException;

/**
 * Class FilterResolver
 *
 * @package Vitoutry\LaravelFormBuilder\Filters
...
class FilterResolver
{
    ...
    {
        return "\\Vitoutry\\LaravelFormBuilder\\Filters\\Collection\\";
    }
}