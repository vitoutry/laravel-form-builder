...
namespace Vitoutry\LaravelFormBuilder;
...
use Vitoutry\LaravelFormBuilder\Traits\ValidatesWhenResolved;
...
class FormBuilderServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands('Vitoutry\LaravelFormBuilder\Console\FormMakeCommand');
        ...
        $this->app->alias('laravel-form-builder', 'Vitoutry\LaravelFormBuilder\FormBuilder');
    ...
    protected function registerFormHelper()
    {
        ...
        $this->app->alias('laravel-form-helper', 'Vitoutry\LaravelFormBuilder\FormHelper');
    }
