...
namespace {
    ...
    class FormBuilderTest extends FormBuilderTestCase
    {
        ...
        public function it_creates_custom_form_and_sets_options_on_it()
        {
            ...
            $this->assertInstanceOf('Vitoutry\\LaravelFormBuilder\\Form', $customForm);
        ...
        public function it_receives_creation_events()
        {
            ...
            $this->assertEquals(
                [
                    // Plain: form first
                    'Vitoutry\LaravelFormBuilder\Events\AfterFormCreation',
                    'Vitoutry\LaravelFormBuilder\Events\AfterFieldCreation',
                    'Vitoutry\LaravelFormBuilder\Events\AfterFieldCreation',
